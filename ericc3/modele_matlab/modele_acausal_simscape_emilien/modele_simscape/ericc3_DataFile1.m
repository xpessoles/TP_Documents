...
%Translation Method - Cartesian
%Rotation Method - Arbitrary Axis
smiData.RigidTransform(9).translation = [282 0 0];  % mm
...
%Translation Method - Cartesian
%Rotation Method - Arbitrary Axis
smiData.RigidTransform(10).translation = [-106.78924731182794 5.6843418860808015e-14 37.000000000000767];  % mm
smiData.RigidTransform(10).angle = 1.1991648532595984e-16;  % rad
smiData.RigidTransform(10).axis = [0.23145754764395443 0.97284500494099602 1.3500936548463349e-17];
...
smiData.RevoluteJoint(5).Rz.Pos = 1.3200544332246134e-17;  % deg
