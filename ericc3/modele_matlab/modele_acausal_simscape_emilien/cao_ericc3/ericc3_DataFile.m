...
smiData.Solid(1).mass = 5.5649661309075054;  % kg
smiData.Solid(1).CoM = [13.947329222260251 1.7221923273403443 73.969728157571197];  % mm
smiData.Solid(1).MoI = [30005.693205382948 151867.58537026585 143649.43768189158];  % kg*mm^2
smiData.Solid(1).PoI = [-810.55924681529848 -8858.7046326783802 -1392.2465229587115];  % kg*mm^2
...
smiData.Solid(2).MoI = [3663.5450553416135 23143.368394426194 22600.516490455087];  % kg*mm^2
...
smiData.Solid(4).MoI = [202.96519187623178 205.87251486464459 105.55857071799551];  % kg*mm^2
...
smiData.Solid(5).PoI = [34425.123712696368 16094.054994755112 -22328.889822980218];  % kg*mm^2
