...
%Inertia Type - Custom
%Visual Properties - Simple
smiData.Solid(2).mass = 1.8424860004287902;  % kg
smiData.Solid(2).CoM = [18.663344986038709 -0.00019380608295130024 99.829651664470404];  % mm
smiData.Solid(2).MoI = [3663.5450553416122 23143.368394426194 22600.516490455091];  % kg*mm^2
smiData.Solid(2).PoI = [-0.0038243779380792136 61.225255676957794 0.055603542153124616];  % kg*mm^2
...
smiData.Solid(4).CoM = [0 -36.461525852781591 45.000000000000007];  % mm
smiData.Solid(4).MoI = [202.96519187623181 205.87251486464456 105.55857071799556];  % kg*mm^2
...
smiData.Solid(5).PoI = [34425.123712696353 16094.054994755112 -22328.889822980225];  % kg*mm^2
...
%Inertia Type - Custom
%Visual Properties - Simple
smiData.Solid(6).mass = 10.94897195176706;  % kg
smiData.Solid(6).CoM = [0 0 88.626543346207654];  % mm
smiData.Solid(6).MoI = [49284.971751952529 49284.971751952522 42696.2785874049];  % kg*mm^2
